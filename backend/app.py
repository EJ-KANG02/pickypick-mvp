            ...
            messages=[
                ...
                },
                {
                    ...
                    "content": (
                        ...
                        "한국인을 위한 추천입니다. 한국인이 자주 먹는 재료, 음식으로 구성해주고, 아이의 연령대를 고려해주세요. "
                        "그리고 메뉴마다 편식 음식, 알러지에서 어떤 점을 고려했는지 (대체 영양소 사용 등) 간단하게 한줄로 설명해주세요."
                        "응답을 다음 JSON 형식으로 제공해 주세요: "
                        '{"meal_1": {"name": "식단 이름", "ingredients": ["재료 1", "재료 2"], "calories": 500, "description": "가지의 영양소 ~~를 대체한 ~~를 넣어 영양소를 고루 갖춘 ~~입니다.",'
